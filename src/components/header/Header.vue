            ...
            <el-col :span="4">
              <div class="div-header-tools-main-city">
                <div class="div-header-tools-main-city-main">
                  <span>送至: </span>
                  <el-dropdown>
                    <span class="el-dropdown-link">{{city}}<i class="el-icon-arrow-down el-icon--right"/></span>
                    <el-dropdown-menu>
                  ...
                  <el-row>
                    <el-col :span="10">
                      <div class="div-header-tools-main-link-main-no_login" v-if="!if_login">
                        <el-link :underline="false" @click="gotoLogin" icon="el-icon-user-solid" type="info">你好，请<span
                          style="color: red; ">登录</span></el-link>
                        <el-link :underline="false" @click="gotoRegister" icon="el-icon-user" type="info">免费注册</el-link>&nbsp;&nbsp;&nbsp;
                      </div>
                      <div class="div-header-tools-main-link-main-yes_login" v-if="if_login">
                        <el-link :underline="false" @click="gotoPersonPage" type="info">欢迎访问WSBook商城：
          ...
          <el-col :span="7">
            <div class="div-header-main-search-ico">
              <div class="div-header-main-search-ico-main">
                <a href="/">
                  <img style="height: 115px; width: 115px" src="~assets/img/ico_upclogo.png"/>
                </a>
              </div>
            </div>
          </el-col>
            ...
            <div class="div-header-main-search-input">
              <el-form :model="search" class="div-header-main-search-form"
                ...
                <el-form-item prop="inputSearchWord">
                  <el-input class="input-to-search" clearable placeholder="查找你喜爱的书籍" v-model="search.inputSearchWord">
                    <el-button @click="submitForm('search')" class="btn" icon="el-icon-search" slot="append"/>
                  </el-input>
                </el-form-item>
              </el-form>
            </div>
          ...
          <el-col :span="7">
            <div class="div-header-main-search-button">
              <div class="div-header-main-search-button-main">
                <el-badge :max="99" :value="this.$store.state.resultInfo.shopCarInfo.list.length" class="div-header-main-search-button-shop_car">
                  <el-button @click="gotoShopCar">购物车</el-button>
                </el-badge>
                <el-badge :max="99" :value="this.$store.state.resultInfo.orderNum" class="div-header-main-search-button-order">
